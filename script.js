...
const phases = [
  ...
  {title:'Chegada a Marte',type:'O IMPOSSÍVEL ACONTECEU',description:'Valentina chega ao planeta vermelho. Enviada para morrer, ela transforma a missão sem esperança em uma conquista que seus comandantes não podem apagar.',enemies:'Missão concluída',movement:'Sem movimentação livre',image:'assets/marte.png',alt:'Tela de abertura de Proyekt Kosmonavta com Marte ao fundo'}
];
let activePhase = 0;
